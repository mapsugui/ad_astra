...
**Rejected: the lead event is the target's own catalogued ephemeris transit** (28 periods before the reference). No new signal.

Source: `campaigns/toi-5379-01/vetting/VETTING.md` and `campaigns/tess-periodic-01/LEAD_VETTING_LOG.md`.
