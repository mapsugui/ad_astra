...
**Superceded by the multi-archive runner:** re-run through `python -m cygnus.multi` on 2026-09-25, steps fetch_products, calibrate_screen, known_signal_recovery, residual_screen, period_aliases, prior_art (ledger fetch_products #1537, calibrate_screen #1538, known_signal_recovery #1539, residual_screen #1540, period_aliases #1541, prior_art #1542). Same retrieved products, same science outputs: entries, depths, k-star calibration and aliases match the production-runner results recorded here; the multi runner additionally records a screen-suitability census and a red-noise systematics model per light curve. The record is regenerated by the multi runner; nothing in the review changes.
...
| Check | State | Note |
|---|---|---|
| Target-to-Gaia identification (proper motion propagated) | passed | TOI-4309.01: Gaia DR3 3762126059756436480 at 0.00" (propagated 2016.0 → J2015.5; 0.10" unpropagated, proper-motion shift 0.10") |
| Stellar priors (Gaia colour and parallax) | passed | TOI-4309.01: Teff 5180 K, R* 0.81 ± 0.06, M* 0.87 ± 0.09, ρ* 1.65 ± 0.43 ρ☉ (dwarf sequence, M_G 5.58, no extinction) |
| Blend and dilution census (Gaia DR3 cone) | passed | TOI-4309.01: 1 Gaia neighbour(s) within 52.5", contamination 0.01%; depth 661 ppm (catalogue depth); none bright enough to produce it alone |
...
| Variable-catalogue collision (VSX) | passed | TOI-4309.01: no VSX entry within 10" |
| Object-class guard (SIMBAD) | passed | TOI-4309.01: BD-08  2955 otype PM* (star_or_other) at 3.1" |
