...
**Superceded by the multi-archive runner:** re-run through `python -m cygnus.multi` on 2026-09-25, steps fetch_products, calibrate_screen, known_signal_recovery, residual_screen, period_aliases, prior_art (ledger fetch_products #1465, calibrate_screen #1466, known_signal_recovery #1467, residual_screen #1468, period_aliases #1469, prior_art #1470). Same retrieved products, same science outputs: entries, depths, k-star calibration and aliases match the production-runner results recorded here; the multi runner additionally records a screen-suitability census and a red-noise systematics model per light curve. The record is regenerated by the multi runner; nothing in the review changes.
...
| Check | State | Note |
|---|---|---|
| Target-to-Gaia identification (proper motion propagated) | passed | TOI-2490.01: Gaia DR3 4818818585874648320 at 0.00" (propagated 2016.0 → J2015.5; 0.01" unpropagated, proper-motion shift 0.01") |
| Stellar priors (Gaia colour and parallax) | passed | TOI-2490.01: Teff 5449 K, R* 1.02 ± 0.08, M* 1.00 ± 0.10, ρ* 0.95 ± 0.25 ρ☉ (dwarf sequence, M_G 4.62, no extinction) |
| Blend and dilution census (Gaia DR3 cone) | inconclusive | TOI-2490.01: 2 Gaia neighbour(s) within 52.5", contamination 14.76%; depth 7064 ppm (measured depth of the recovered catalogued transit); 1 could produce it if fully eclipsed (brightest 4818818482795434112, 50.0", ΔG 1.92); a centroid test is needed |
...
| Variable-catalogue collision (VSX) | passed | TOI-2490.01: no VSX entry within 10" |
| Object-class guard (SIMBAD) | inconclusive | TOI-2490.01: TOI-2490 otype SB* (multiple) at 0.4" |
