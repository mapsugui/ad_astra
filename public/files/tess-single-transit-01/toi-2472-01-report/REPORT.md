...
**Superceded by the multi-archive runner:** re-run through `python -m cygnus.multi` on 2026-09-25, steps fetch_products, calibrate_screen, known_signal_recovery, residual_screen, period_aliases, prior_art (ledger fetch_products #1459, calibrate_screen #1460, known_signal_recovery #1461, residual_screen #1462, period_aliases #1463, prior_art #1464). Same retrieved products, same science outputs: entries, depths, k-star calibration and aliases match the production-runner results recorded here; the multi runner additionally records a screen-suitability census and a red-noise systematics model per light curve. The record is regenerated by the multi runner; nothing in the review changes.
...
| Check | State | Note |
|---|---|---|
| Target-to-Gaia identification (proper motion propagated) | passed | TOI-2472.01: Gaia DR3 3204809355377070336 at 0.00" (propagated 2016.0 → J2015.5; 0.01" unpropagated, proper-motion shift 0.01") |
| Stellar priors (Gaia colour and parallax) | passed | TOI-2472.01: Teff 5840 K, R* 1.37 ± 0.11, M* 1.25 ± 0.13, ρ* 0.49 ± 0.13 ρ☉ (dwarf sequence, M_G 3.54, no extinction) |
| Blend and dilution census (Gaia DR3 cone) | inconclusive | TOI-2472.01: 2 Gaia neighbour(s) within 52.5", contamination 0.34%; depth 390 ppm (catalogue depth); 2 could produce it if fully eclipsed (brightest 3204808599462824704, 34.8", ΔG 6.90); a centroid test is needed |
| Pointing and quality census per event | failed | 1 persistent event(s), 0 clean; BJD 2461024.2024 suspect: manual exclude (in event) |
...
| Variable-catalogue collision (VSX) | passed | TOI-2472.01: no VSX entry within 10" |
| Object-class guard (SIMBAD) | passed | TOI-2472.01: BD-03   785 otype * (star_or_other) at 0.4" |
