...
**Superceded by the multi-archive runner:** re-run through `python -m cygnus.multi` on 2026-09-25, steps fetch_products, calibrate_screen, known_signal_recovery, residual_screen, period_aliases, prior_art (ledger fetch_products #1441, calibrate_screen #1442, known_signal_recovery #1443, residual_screen #1444, period_aliases #1445, prior_art #1446). Same retrieved products, same science outputs: entries, depths, k-star calibration and aliases match the production-runner results recorded here; the multi runner additionally records a screen-suitability census and a red-noise systematics model per light curve. The record is regenerated by the multi runner; nothing in the review changes.
...
| Check | State | Note |
|---|---|---|
| Target-to-Gaia identification (proper motion propagated) | passed | TOI-2435.01: Gaia DR3 1610656720761692928 at 0.00" (propagated 2016.0 → J2015.5; 0.02" unpropagated, proper-motion shift 0.02") |
| Stellar priors (Gaia colour and parallax) | passed | TOI-2435.01: Teff 5626 K, R* 0.91 ± 0.07, M* 0.94 ± 0.09, ρ* 1.23 ± 0.32 ρ☉ (dwarf sequence, M_G 5.09, no extinction) |
| Blend and dilution census (Gaia DR3 cone) | passed | TOI-2435.01: 3 Gaia neighbour(s) within 52.5", contamination 0.09%; depth 1840 ppm (catalogue depth); none bright enough to produce it alone |
...
| Variable-catalogue collision (VSX) | passed | TOI-2435.01: no VSX entry within 10" |
| Object-class guard (SIMBAD) | passed | TOI-2435.01: TYC 3863-1448-1 otype Em* (star_or_other) at 0.5" |
