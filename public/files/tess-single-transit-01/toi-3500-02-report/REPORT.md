...
**Superceded by the multi-archive runner:** re-run through `python -m cygnus.multi` on 2026-09-25, steps fetch_products, calibrate_screen, known_signal_recovery, residual_screen, period_aliases, prior_art (ledger fetch_products #1513, calibrate_screen #1514, known_signal_recovery #1515, residual_screen #1516, period_aliases #1517, prior_art #1518). Same retrieved products, same science outputs: entries, depths, k-star calibration and aliases match the production-runner results recorded here; the multi runner additionally records a screen-suitability census and a red-noise systematics model per light curve. The record is regenerated by the multi runner; nothing in the review changes.
...
| Check | State | Note |
|---|---|---|
| Target-to-Gaia identification (proper motion propagated) | passed | TOI-3500.02: Gaia DR3 3471495415361216512 at 0.00" (propagated 2016.0 → J2015.5; 0.04" unpropagated, proper-motion shift 0.03") |
| Stellar priors (Gaia colour and parallax) | passed | TOI-3500.02: Teff 5311 K, R* 0.95 ± 0.08, M* 0.97 ± 0.10, ρ* 1.14 ± 0.30 ρ☉ (dwarf sequence, M_G 4.92, no extinction) |
| Blend and dilution census (Gaia DR3 cone) | inconclusive | TOI-3500.02: 9 Gaia neighbour(s) within 52.5", contamination 10.25%; depth 7220 ppm (measured depth of the recovered catalogued transit); 2 could produce it if fully eclipsed (brightest 3471495419656596352, 3.7", ΔG 2.72); a centroid test is needed |
| Pointing and quality census per event | failed | 21 persistent event(s), 13 clean; BJD 2459322.6415 suspect: scattered light 2 (within ±0.25 d), SAP_BKG z=+14.6; BJD 2459322.6554 suspect: scattered light 2 (within ±0.25 d), SAP_BKG z=+15.2; BJD 2459322.6901 suspect: scattered light 2 (within ±0.25 d), SAP_BKG z=+17.2; BJD 2459322.6957 suspect: scattered light 2 (with… |
...
| Variable-catalogue collision (VSX) | passed | TOI-3500.02: no VSX entry within 10" |
| Object-class guard (SIMBAD) | passed | TOI-3500.02: UCAC2  19403154 otype PM* (star_or_other) at 1.1" |
