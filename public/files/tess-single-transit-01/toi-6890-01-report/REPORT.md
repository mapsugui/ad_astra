...
| Check | State | Note |
|---|---|---|
| Target-to-Gaia identification (proper motion propagated) | passed | TOI-6890.01: Gaia DR3 5679602531040786816 at 0.00" (propagated 2016.0 → J2015.5; 0.01" unpropagated, proper-motion shift 0.01") |
| Stellar priors (Gaia colour and parallax) | passed | TOI-6890.01: Teff 5851 K, R* 1.16 ± 0.09, M* 1.11 ± 0.11, ρ* 0.72 ± 0.19 ρ☉ (dwarf sequence, M_G 4.14, no extinction) |
| Blend and dilution census (Gaia DR3 cone) | inconclusive | TOI-6890.01: 7 Gaia neighbour(s) within 52.5", contamination 0.88%; depth 2109 ppm (measured depth of the recovered catalogued transit); 2 could produce it if fully eclipsed (brightest 5679602977717385472, 43.8", ΔG 6.04); a centroid test is needed |
| Pointing and quality census per event | inconclusive | 1 persistent event(s), 0 clean; BJD 2459272.2813 caution: argabrightening (within ±0.25 d), coarse point (within ±0.25 d), manual exclude (within ±0.25 d) |
...
| Variable-catalogue collision (VSX) | passed | TOI-6890.01: no VSX entry within 10" |
| Object-class guard (SIMBAD) | passed | TOI-6890.01: TYC 6040-575-1 otype * (star_or_other) at 0.2" |
