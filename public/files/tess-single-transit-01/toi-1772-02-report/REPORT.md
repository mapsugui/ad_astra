...
**Superceded by the multi-archive runner:** re-run through `python -m cygnus.multi` on 2026-09-25, steps fetch_products, calibrate_screen, known_signal_recovery, residual_screen, period_aliases, prior_art (ledger fetch_products #1315, calibrate_screen #1316, known_signal_recovery #1317, residual_screen #1318, period_aliases #1319, prior_art #1320). Same retrieved products, same science outputs: entries, depths, k-star calibration and aliases match the production-runner results recorded here; the multi runner additionally records a screen-suitability census and a red-noise systematics model per light curve. The record is regenerated by the multi runner; nothing in the review changes.
...
| Check | State | Note |
|---|---|---|
| Target-to-Gaia identification (proper motion propagated) | passed | TOI-1772.02: Gaia DR3 749676822006222464 at 0.00" (propagated 2016.0 → J2015.5; 0.02" unpropagated, proper-motion shift 0.02") |
| Stellar priors (Gaia colour and parallax) | passed | TOI-1772.02: Teff 5663 K, R* 0.96 ± 0.08, M* 0.97 ± 0.10, ρ* 1.10 ± 0.28 ρ☉ (dwarf sequence, M_G 4.86, no extinction) |
| Blend and dilution census (Gaia DR3 cone) | inconclusive | TOI-1772.02: 2 Gaia neighbour(s) within 52.5", contamination 0.43%; depth 3322 ppm (measured depth of the recovered catalogued transit); 1 could produce it if fully eclipsed (brightest 749676817711059328, 24.8", ΔG 5.93); a centroid test is needed |
| Pointing and quality census per event | failed | 4 persistent event(s), 1 clean; BJD 2459615.0011 caution: coarse point (within ±0.25 d), manual exclude (within ±0.25 d), momentum dump (within ±0.25 d); BJD 2459621.3970 suspect: manual exclude (in event), MOM_CENTR1 z=+7.7, MOM_CENTR2 z=+13.3, POS_CORR1 z=+7.6, POS_CORR2 z=+13.3; BJD 2458888.0973 caution: manual excl… |
...
| Variable-catalogue collision (VSX) | passed | TOI-1772.02: no VSX entry within 10" |
| Object-class guard (SIMBAD) | passed | TOI-1772.02: BD+35  2144 otype Em* (star_or_other) at 0.7" |
