...
- `gaia_cone_TOI-2666.01_r30as.csv` — gaia, table (Gaia DR3 cone r=30" (2 rows))
- `simbad_TOI-2666.01.csv` — simbad, table (SIMBAD cone r=30" (2 rows))
