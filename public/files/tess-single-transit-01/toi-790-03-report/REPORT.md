...
**Superceded by the multi-archive runner:** re-run through `python -m cygnus.multi` on 2026-09-25, steps fetch_products, calibrate_screen, known_signal_recovery, residual_screen, period_aliases, prior_art (ledger fetch_products #1742, calibrate_screen #1743, known_signal_recovery #1744, residual_screen #1745, period_aliases #1746, prior_art #1747). Same retrieved products, same science outputs: entries, depths, k-star calibration and aliases match the production-runner results recorded here; the multi runner additionally records a screen-suitability census and a red-noise systematics model per light curve. The record is regenerated by the multi runner; nothing in the review changes.
...
| Check | State | Note |
|---|---|---|
| Target-to-Gaia identification (proper motion propagated) | passed | TOI-790.03: Gaia DR3 5277235112690260864 at 0.00" (propagated 2016.0 → J2015.5; 0.03" unpropagated, proper-motion shift 0.03") |
| Stellar priors (Gaia colour and parallax) | passed | TOI-790.03: Teff 6706 K, R* 1.50 ± 0.12, M* 1.35 ± 0.14, ρ* 0.40 ± 0.10 ρ☉ (dwarf sequence, M_G 3.18, no extinction) |
| Blend and dilution census (Gaia DR3 cone) | inconclusive | TOI-790.03: 14 Gaia neighbour(s) within 52.5", contamination 1.69%; depth 1998 ppm (measured depth of the recovered catalogued transit); 2 could produce it if fully eclipsed (brightest 5277235013908806656, 41.0", ΔG 4.80); a centroid test is needed |
| Pointing and quality census per event | failed | 19 persistent event(s), 18 clean; BJD 2458568.4255 suspect: MOM_CENTR2 z=-12.2, POS_CORR2 z=-12.2 |
...
| Variable-catalogue collision (VSX) | passed | TOI-790.03: no VSX entry within 10" |
| Object-class guard (SIMBAD) | passed | TOI-790.03: TOI-790.01 otype Pl? (star_or_other) at 0.8" |
