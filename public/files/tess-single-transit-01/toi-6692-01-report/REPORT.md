...
**Superceded by the multi-archive runner:** re-run through `python -m cygnus.multi` on 2026-09-25, steps fetch_products, calibrate_screen, known_signal_recovery, residual_screen, period_aliases, prior_art (ledger fetch_products #1694, calibrate_screen #1695, known_signal_recovery #1696, residual_screen #1697, period_aliases #1698, prior_art #1699). Same retrieved products, same science outputs: entries, depths, k-star calibration and aliases match the production-runner results recorded here; the multi runner additionally records a screen-suitability census and a red-noise systematics model per light curve. The record is regenerated by the multi runner; nothing in the review changes.
...
| Check | State | Note |
|---|---|---|
| Target-to-Gaia identification (proper motion propagated) | passed | TOI-6692.01: Gaia DR3 6349145498210403840 at 0.00" (propagated 2016.0 → J2015.5; 0.02" unpropagated, proper-motion shift 0.02") |
| Stellar priors (Gaia colour and parallax) | passed | TOI-6692.01: Teff 5540 K, R* 1.16 ± 0.09, M* 1.12 ± 0.11, ρ* 0.71 ± 0.19 ρ☉ (dwarf sequence, M_G 4.12, no extinction) |
| Blend and dilution census (Gaia DR3 cone) | inconclusive | TOI-6692.01: 9 Gaia neighbour(s) within 52.5", contamination 3.65%; depth 5187 ppm (measured depth of the recovered catalogued transit); 1 could produce it if fully eclipsed (brightest 6349145498210403328, 38.2", ΔG 3.95); a centroid test is needed |
| Pointing and quality census per event | failed | 6 persistent event(s), 0 clean; BJD 2460140.6013 suspect: manual exclude (within ±0.25 d), momentum dump (within ±0.25 d), scattered light 2 (within ±0.25 d), MOM_CENTR1 z=+17.6, MOM_CENTR2 z=-17.6, POS_CORR1 z=+21.4, POS_CORR2 z=-18.1, SAP_BKG z=+944.7; BJD 2460140.6263 suspect: manual exclude (within ±0.25 d), moment… |
...
| Variable-catalogue collision (VSX) | passed | TOI-6692.01: no VSX entry within 10" |
| Object-class guard (SIMBAD) | passed | TOI-6692.01: TOI-6692b otype Pl (star_or_other) at 0.7" |
