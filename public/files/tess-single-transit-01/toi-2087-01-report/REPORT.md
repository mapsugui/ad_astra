...
**Superceded by the multi-archive runner:** re-run through `python -m cygnus.multi` on 2026-09-25, steps fetch_products, calibrate_screen, known_signal_recovery, residual_screen, period_aliases, prior_art (ledger fetch_products #1369, calibrate_screen #1370, known_signal_recovery #1371, residual_screen #1372, period_aliases #1373, prior_art #1374). Same retrieved products, same science outputs: entries, depths, k-star calibration and aliases match the production-runner results recorded here; the multi runner additionally records a screen-suitability census and a red-noise systematics model per light curve. The record is regenerated by the multi runner; nothing in the review changes.
...
| Check | State | Note |
|---|---|---|
| Target-to-Gaia identification (proper motion propagated) | passed | TOI-2087.01: Gaia DR3 1712288703684932992 at 0.00" (propagated 2016.0 → J2015.5; 0.01" unpropagated, proper-motion shift 0.01") |
| Stellar priors (Gaia colour and parallax) | passed | TOI-2087.01: Teff 5615 K, R* 0.95 ± 0.08, M* 0.97 ± 0.10, ρ* 1.14 ± 0.30 ρ☉ (dwarf sequence, M_G 4.92, no extinction) |
| Blend and dilution census (Gaia DR3 cone) | inconclusive | TOI-2087.01: 1 Gaia neighbour(s) within 52.5", contamination 0.07%; depth 548 ppm (catalogue depth); 1 could produce it if fully eclipsed (brightest 1712287569813566720, 49.0", ΔG 7.84); a centroid test is needed |
...
| Variable-catalogue collision (VSX) | passed | TOI-2087.01: no VSX entry within 10" |
| Object-class guard (SIMBAD) | passed | TOI-2087.01: BD+75   522 otype * (star_or_other) at 0.3" |
