...
**Rejected: the lead event is the target's own catalogued ephemeris transit** (one period after the reference; the difference image is 132.7 arcsec off at 254 sigma - the deficit is elsewhere). No new signal.

Source: `campaigns/toi-2137-01/vetting/VETTING.md` and `campaigns/tess-periodic-01/LEAD_VETTING_LOG.md`.
