...
| Check | State | Note |
|---|---|---|
| Target-to-Gaia identification (proper motion propagated) | passed | TOI-6980.01: Gaia DR3 2516286274890560000 at 0.00" (propagated 2016.0 → J2015.5; 0.05" unpropagated, proper-motion shift 0.05") |
| Stellar priors (Gaia colour and parallax) | passed | TOI-6980.01: Teff 6211 K, R* 1.19 ± 0.09, M* 1.15 ± 0.11, ρ* 0.69 ± 0.18 ρ☉ (dwarf sequence, M_G 4.03, no extinction) |
| Blend and dilution census (Gaia DR3 cone) | inconclusive | TOI-6980.01: 5 Gaia neighbour(s) within 52.5", contamination 0.12%; depth 409 ppm (catalogue depth); 1 could produce it if fully eclipsed (brightest 2516286377969774464, 28.5", ΔG 7.33); a centroid test is needed |
...
| Variable-catalogue collision (VSX) | passed | TOI-6980.01: no VSX entry within 10" |
| Object-class guard (SIMBAD) | passed | TOI-6980.01: HD  15819 otype PM* (star_or_other) at 1.4" |
