...
**Superceded by the multi-archive runner:** re-run through `python -m cygnus.multi` on 2026-09-25, steps fetch_products, calibrate_screen, known_signal_recovery, residual_screen, period_aliases, prior_art (ledger fetch_products #1489, calibrate_screen #1490, known_signal_recovery #1491, residual_screen #1492, period_aliases #1493, prior_art #1494). Same retrieved products, same science outputs: entries, depths, k-star calibration and aliases match the production-runner results recorded here; the multi runner additionally records a screen-suitability census and a red-noise systematics model per light curve. The record is regenerated by the multi runner; nothing in the review changes.
...
| Check | State | Note |
|---|---|---|
| Target-to-Gaia identification (proper motion propagated) | passed | TOI-2634.01: Gaia DR3 5642251292706560 at 0.00" (propagated 2016.0 → J2015.5; 0.02" unpropagated, proper-motion shift 0.02") |
| Stellar priors (Gaia colour and parallax) | inconclusive | TOI-2634.01: dwarf priors not applied — RUWE 5.6029916 ≥ 1.4 (or missing): astrometry may be perturbed |
| Blend and dilution census (Gaia DR3 cone) | passed | TOI-2634.01: 1 Gaia neighbour(s) within 52.5", contamination 0.16%; depth 3954 ppm (measured depth of the recovered catalogued transit); none bright enough to produce it alone |
| Pointing and quality census per event | failed | 1 persistent event(s), 0 clean; BJD 2460249.0359 suspect: POS_CORR1 z=+6.8, SAP_BKG z=+14.1 |
...
| Variable-catalogue collision (VSX) | passed | TOI-2634.01: no VSX entry within 10" |
| Object-class guard (SIMBAD) | passed | TOI-2634.01: TYC   50-821-1 otype Em* (star_or_other) at 0.6" |
