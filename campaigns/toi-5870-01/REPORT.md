...
**Superceded by the multi-archive runner:** re-run through `python -m cygnus.multi` on 2026-09-25, steps fetch_products, calibrate_screen, known_signal_recovery, residual_screen, period_aliases, prior_art (ledger fetch_products #1609, calibrate_screen #1610, known_signal_recovery #1611, residual_screen #1612, period_aliases #1613, prior_art #1614). Same retrieved products, same science outputs: entries, depths, k-star calibration and aliases match the production-runner results recorded here; the multi runner additionally records a screen-suitability census and a red-noise systematics model per light curve. The record is regenerated by the multi runner; nothing in the review changes.
...
| Check | State | Note |
|---|---|---|
| Target-to-Gaia identification (proper motion propagated) | passed | TOI-5870.01: Gaia DR3 1742536509083998208 at 0.00" (propagated 2016.0 → J2015.5; 0.01" unpropagated, proper-motion shift 0.01") |
| Stellar priors (Gaia colour and parallax) | passed | TOI-5870.01: Teff 6140 K, R* 1.41 ± 0.11, M* 1.29 ± 0.13, ρ* 0.46 ± 0.12 ρ☉ (dwarf sequence, M_G 3.42, no extinction) |
| Blend and dilution census (Gaia DR3 cone) | passed | TOI-5870.01: 11 Gaia neighbour(s) within 52.5", contamination 0.74%; depth 3736 ppm (catalogue depth); none bright enough to produce it alone |
| Pointing and quality census per event | inconclusive | 1 persistent event(s), 0 clean; BJD 2460538.3600 caution: manual exclude (within ±0.25 d) |
...
| Variable-catalogue collision (VSX) | passed | TOI-5870.01: no VSX entry within 10" |
| Object-class guard (SIMBAD) | passed | TOI-5870.01: TYC 1124-343-1 otype * (star_or_other) at 0.3" |
