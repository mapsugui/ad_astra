...
**Superceded by the multi-archive runner:** re-run through `python -m cygnus.multi` on 2026-09-25, steps fetch_products, calibrate_screen, known_signal_recovery, residual_screen, period_aliases, prior_art (ledger fetch_products #1561, calibrate_screen #1562, known_signal_recovery #1563, residual_screen #1564, period_aliases #1565, prior_art #1566). Same retrieved products, same science outputs: entries, depths, k-star calibration and aliases match the production-runner results recorded here; the multi runner additionally records a screen-suitability census and a red-noise systematics model per light curve. The record is regenerated by the multi runner; nothing in the review changes.
...
| Check | State | Note |
|---|---|---|
| Target-to-Gaia identification (proper motion propagated) | passed | TOI-4509.01: Gaia DR3 5501711995027853568 at 0.00" (propagated 2016.0 → J2015.5; 0.00" unpropagated, proper-motion shift 0.00") |
| Stellar priors (Gaia colour and parallax) | passed | TOI-4509.01: Teff 6697 K, R* 1.69 ± 0.14, M* 1.52 ± 0.15, ρ* 0.32 ± 0.08 ρ☉ (dwarf sequence, M_G 2.66, no extinction) |
| Blend and dilution census (Gaia DR3 cone) | inconclusive | TOI-4509.01: 16 Gaia neighbour(s) within 52.5", contamination 73.80%; depth 3178 ppm (catalogue depth); 4 could produce it if fully eclipsed (brightest 5501712025090279424, 34.1", ΔG -1.07); a centroid test is needed |
| Pointing and quality census per event | failed | 1 persistent event(s), 0 clean; BJD 2459964.1819 suspect: scattered light 2 (within ±0.25 d), MOM_CENTR1 z=-12.6, MOM_CENTR2 z=-12.9, POS_CORR1 z=-9.5, POS_CORR2 z=-16.0, SAP_BKG z=+5.5 |
...
| Variable-catalogue collision (VSX) | passed | TOI-4509.01: no VSX entry within 10" |
| Object-class guard (SIMBAD) | passed | TOI-4509.01: TYC 8536-665-1 otype * (star_or_other) at 0.1" |
