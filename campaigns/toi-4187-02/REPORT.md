...
**Superceded by the multi-archive runner:** re-run through `python -m cygnus.multi` on 2026-09-25, steps fetch_products, calibrate_screen, known_signal_recovery, residual_screen, period_aliases, prior_art (ledger fetch_products #1525, calibrate_screen #1526, known_signal_recovery #1527, residual_screen #1528, period_aliases #1529, prior_art #1530). Same retrieved products, same science outputs: entries, depths, k-star calibration and aliases match the production-runner results recorded here; the multi runner additionally records a screen-suitability census and a red-noise systematics model per light curve. The record is regenerated by the multi runner; nothing in the review changes.
...
| Check | State | Note |
|---|---|---|
| Target-to-Gaia identification (proper motion propagated) | passed | TOI-4187.02: Gaia DR3 5048187328587727744 at 0.00" (propagated 2016.0 → J2015.5; 0.05" unpropagated, proper-motion shift 0.05") |
| Stellar priors (Gaia colour and parallax) | inconclusive | TOI-4187.02: dwarf priors not applied — 1.39 mag above (brighter: evolved, unresolved binary or young) the dwarf sequence at this colour; dwarf priors not applied |
| Blend and dilution census (Gaia DR3 cone) | passed | TOI-4187.02: 0 Gaia neighbour(s) within 52.5", contamination 0.00%; depth 534 ppm (catalogue depth); none bright enough to produce it alone |
| Pointing and quality census per event | failed | 2 persistent event(s), 1 clean; BJD 2461222.3848 suspect: SAP_BKG z=+7.6 |
...
| Variable-catalogue collision (VSX) | passed | TOI-4187.02: no VSX entry within 10" |
| Object-class guard (SIMBAD) | passed | TOI-4187.02: HD  20143 otype PM* (star_or_other) at 1.4" |
