...
from cygnus_multi import nss, systematics
from cygnus_multi.archives import base
from cygnus_multi.archives.base import Target
from cygnus_multi.lightcurve import SpocLightCurve
...
def test_nss_vetting_flags_a_known_companion(tmp_path):
    ...
    assert "known astrometric companion" in res["note"]
