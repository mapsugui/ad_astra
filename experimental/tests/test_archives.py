...
from cygnus_multi.archives.base import AdapterUnavailable, ProductRef, Target
from cygnus_multi.readers import read_lightcurve, read_table
...
def test_ztf_votable_lightcurve_reads_magnitudes(tmp_path):
    ...
    from cygnus_multi.readers import read_lightcurve
